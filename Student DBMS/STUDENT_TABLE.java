...
public class STUDENT_TABLE {
	...
	private static final String url = "jdbc:mysql://127.0.0.1:3306/fifth_internship_project";
		...
		ADDB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					PreparedStatement pst = con.prepareStatement("insert into student_table_data values(? , ? , ? ,?)");
		...
		UPDATEB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					PreparedStatement pst = con.prepareStatement("update student_table_data set SName = '"+NAMETF.getText()+"' , SBranch = '"+BRANCHTF.getText()+"' , SPhone = '"+PHONETF.getText()+"' where SRoll = '"+ROLLTF.getText()+"' ; ");
					pst.executeUpdate();
		...
		SEARCHB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					PreparedStatement pst = con.prepareStatement("select * from student_table_data where SRoll = ? ;");
					pst.setString(1, ROLLTF.getText());
		...
		DELETEB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					PreparedStatement pst = con.prepareStatement("delete from student_table_data where SRoll = ? ;");
					pst.setString(1, ROLLTF.getText());
					pst.execute();
		...
		FETCHB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					PreparedStatement ps = con.prepareStatement("select * from student_table_data ;");
