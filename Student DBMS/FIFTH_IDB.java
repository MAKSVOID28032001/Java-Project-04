	...
	public static void main(String[] args) {
		...
		try
		{
			...
			try
			{
				...
				st.executeUpdate("create database fifth_internship_project ;");
			}
			...
			try
			{
				...
				st.executeUpdate("use fifth_internship_project ;");
			}
			...
			try
			{
				String table = "create table student_table_data("
									+"SRoll varchar(20),"
									+"SName varchar(20),"
									+"SBranch varchar(20),"
									+"SPhone varchar(20)"
				...
				System.out.println("CREATE student_table_data TABLE");
